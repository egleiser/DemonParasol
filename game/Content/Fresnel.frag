...
inputs
{
    ...
    float PulseTimeScale;
    float PulseIntensity;
    float PulseIntensityOffset;
...
void Fresnel(inout Data data)
{
    ...
    data.Additive = scalar * data.EdgeGlowColor * texColor * ((sin(data.Time*data.PulseTimeScale)+data.PulseIntensityOffset)*data.PulseIntensity);
}